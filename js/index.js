...
// let prices = 'Price: $2, €1, ¥9';

// const regExpByPrices = /\p{Sc}\d/ug;

// console.log(prices.match(regExpByPrices));

// const myText = 'React is UI Framework ';

// const regExp_5 = /^............FRAMEWORK.$/i;

// // console.log(regExp_5.test(myText));

// const currentTime = `20:00`;

// const regExpByCheckTime = /\d\d:\d\d/gi;

// console.log(regExpByCheckTime.test(currentTime));
